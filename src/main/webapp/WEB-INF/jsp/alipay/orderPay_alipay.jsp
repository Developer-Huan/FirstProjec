...
<%@ page import="com.example.utils.AlipayConfig"%>
...
<%
	...
	//订单名称，必填
	String subject = new String("酒店退房支付".getBytes("ISO-8859-1"),"UTF-8");
	//商品描述，可空
	String body = new String("客户付款".getBytes("ISO-8859-1"),"UTF-8");
